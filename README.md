...
"hjalp":     { "visa": true, "rubrik": "Behöver du hjälp att rösta?",
               "text": "Majornabon och Majpostenläsaren Marcus Wernberger Jonsson har gjort hjalpmigrosta.se, en fristående och partipolitiskt obunden guide till valet på fjorton språk.",
...
- `extra` i en ruta är en avslutande mening som bara visas från 600 px containerbredd (`.ruta-extra`, dold som standard). Den ligger i samma stycke som `text`, så meningarna hänger ihop när båda syns. Uppmätt på index: utan den är rösthjälpsrutan 6 rader i 320 px och 5 i 390 px, med den 8 respektive 7. Rutorna ligger sida vid sida från 900 px containerbredd, under varandra på mobil, och visas även när `inbaddad` är på.
