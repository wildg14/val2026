...
| `forbered_tvaar.py --valnatt-data MAPP` | Bygger testsidan `tmp/tvaar/` (gitignorerad) med två år: 2022 ur `data/` och 2026 ur en valnattskörning | `.venv/bin/python verktyg/forbered_tvaar.py --valnatt-data /tmp/valnatt-test/data` |
| `tvaar-check.js [URL]` | Kontrollerar tvåårssidan: två årsknappar, 23 distrikt båda åren, Sandarna 2026 och Sandarne 2022, samma viewBox, inga JS-fel | `node verktyg/tvaar-check.js` |
