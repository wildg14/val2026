...
**Statusraden tiger för ett färdigräknat val före valåret.** Den sade "Slutligt resultat 2022. Valet 2026 är söndag 13 september.", vilket upprepade årväljaren och den redaktionella meningen ovanför, och togs bort 2026-09-08. Raden bär fortfarande valnattens "Preliminärt, 12 av 23 distrikt räknade. Uppdaterad 21:35." med knappen "Ladda om", det andra årets "Slutligt resultat 2022. Ladda om", och "Slutligt resultat, riksdagsvalet 2026." när räkningen är klar. `statusradKommer()` avgör ur konfigen, alltså innan datan kommit, om raden ska ta plats: den döljs helt när valåret ligger efter standardåret och `valnatt` är falskt. Samma dag togs valdeltagandemeningen ("82,8 % röstade, mot 84,2 % i riket.") bort ur toppsvaret; valdeltagandet finns kvar som kurva i "Majorna sedan 2006" men inte längre som siffra i sidhuvudet.
